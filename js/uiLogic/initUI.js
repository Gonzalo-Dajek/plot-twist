...
import { initCrossDataSetLinkTable } from "./crossDataSetLinks.js";

/**
 * initializes all the ui components
 */
export function initializeUI(plots, url, links) {
    // let clientName = prompt("Enter Your name:", "");
    let clientName = "TODO";
    let eventsCoordinatorRef = {
        eventsCoordinator: new eventsCoordinator(plots, url, links, clientName)
    };
    ...
    initCrossDataSetLinkTable(eventsCoordinatorRef);
